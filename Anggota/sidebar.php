...
function getCorrectPath($targetPath) {
    ...
    if (strpos($currentDir, '/Anggota/kegiatan') !== false || 
        strpos($currentDir, '/Anggota/anggota') !== false || 
        strpos($currentDir, '/Anggota/presensi') !== false) {
        // We're in a subfolder, need to go up one level
        return '../../' . $targetPath;
    } elseif (strpos($currentDir, '/Anggota') !== false) {
...
$menuItems = [
    [
        ...
        'path' => 'Anggota/dashboard.php',
        'file' => 'dashboard.php'
    ],
    [
        'title' => 'Data Kegiatan',
        'icon' => 'fas fa-calendar-alt',
        'path' => 'Anggota/kegiatan/data-kegiatan.php',
        'file' => 'data-kegiatan.php'
    ],
    [
        'title' => 'Data Anggota',
        'icon' => 'fas fa-users',
        'path' => 'Anggota/anggota/data-anggota.php',
        'file' => 'data-anggota.php'
    ],
    [
        'title' => 'Presensi',
        'icon' => 'fas fa-check-circle',
        'path' => 'Anggota/presensi/data-presensi.php',
