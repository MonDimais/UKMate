                        ...
                        <?php foreach ($kegiatan_data as $row): ?>
                            ...
                            <div id="modal-<?= $row['id_kegiatan'] ?>" class="modal fixed inset-0 bg-black bg-opacity-50 hidden flex items-center justify-center z-50" data-modal-id="<?= $row['id_kegiatan'] ?>">
                                <div class="bg-white rounded-lg p-6 w-full max-w-2xl relative max-h-[90vh] overflow-y-auto">
                                    ...
                                    // Cek apakah query presensi berhasil
                                    if (!$result_presensi) {
                                        echo "<p class='text-red-500'>Error loading presensi: " . mysqli_error($koneksi) . "</p>";
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="border px-4 py-2"><?= date('d M Y H:i', strtotime($p['waktu_presensi'])) ?></td>
                                                        </tr>
                                                    <?php 
                                                        endwhile;
                                                    else: 
                                                    ?>
                                                        <tr>
                                                            <td colspan="3" class="border px-4 py-2 text-center text-gray-500">Belum ada yang presensi.</td>
                                                        </tr>
                                                    <?php endif; ?>
                                                </tbody>
                                            </table>
                                            <div class="mt-4 text-right">
                                                <button onclick="downloadPDF(<?= $row['id_kegiatan'] ?>)" class="bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700">
                                                    Download PDF
                                                </button>
                                            </div>
                                        </div>
