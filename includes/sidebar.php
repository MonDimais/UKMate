...
function getCorrectPath($relativePath) {
    // Menghitung jumlah folder dari root ke halaman sekarang
    $depth = substr_count($_SERVER['PHP_SELF'], '/') - 1;

    // Tambahkan ../ sebanyak kedalaman
...
$menuItems = [
    ...
    [
        ...
        'path' => 'Anggota/kehadiran.php',
        'file' => 'kehadiran.php'
    ],
    [
        'title' => 'Kegiatan',
        'icon' => 'fas fa-users',
        'path' => 'Anggota/detail_ukm.php',
        'file' => 'detail_ukm.php'
    ],
    [
        'title' => 'Anggota UKM',
        'icon' => 'fas fa-check-circle',
        'path' => 'Anggota/anggota_ukm.php',
        'file' => 'anggota_ukm.php'
    ]
];
?>
